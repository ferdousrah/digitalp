...
<div class="container-custom px-4 sm:px-6 lg:px-8 pb-16">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('gallery.show', $album) }}" class="group relative aspect-video bg-surface-100 rounded-xl overflow-hidden">
            <x-media-image :model="$album" collection="album_cover" size="medium" :alt="$album->title" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
