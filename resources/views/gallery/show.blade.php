...
<div class="container-custom px-4 sm:px-6 lg:px-8 pb-16">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="aspect-square bg-surface-100 rounded-lg overflow-hidden">
            <x-media-image :model="$item" collection="item_image" size="medium" :alt="$item->title" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        @endforeach
    </div>
</div>
